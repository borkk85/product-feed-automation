...
class PFA_Queue_Manager
{
     ...
     */
    private function is_product_in_queue($product_id, $queue, $product_data = null)
    {
    ...
    private function generate_status()
    {
        ...
        $this->log_message("Status generation - Scheduled posts count: " . $scheduled_posts_count);
        $this->log_message("Status generation - Posts today: " . $posts_today);
        $this->log_message("Status generation - Max posts: " . $max_posts);
